...
class PublicHolidaysMobileLayout extends StatelessWidget with PublicHolidaysPermissionMixin {
  const PublicHolidaysMobileLayout({
  ...
  Widget build(BuildContext context) {
    return PublicHolidaysContent(
      ...
      header: DigifyMobileTabHeader(
        ...
        trailing: canCreatePublicHoliday
