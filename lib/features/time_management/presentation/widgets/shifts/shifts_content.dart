...
import 'package:grc/features/time_management/presentation/widgets/shifts/components/shifts_content_widget.dart';
      ...
      child: SingleChildScrollView(
        ...
        child: Column(
          ...
          children: [
            ...
            Gap(sectionSpacing),
            ShiftsContentWidget(enterpriseId: enterpriseId!, onDelete: onDelete),
          ],
        ),
      ),
    );
