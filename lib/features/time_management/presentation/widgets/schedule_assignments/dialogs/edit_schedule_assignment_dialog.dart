...
import 'package:grc/features/time_management/presentation/widgets/schedule_assignments/dialogs/edit_schedule_assignment_mobile_sheet.dart';
...
class EditScheduleAssignmentDialog extends ConsumerStatefulWidget {
  ...
  static Future<void> show(BuildContext context, int enterpriseId, ScheduleAssignment assignment) {
    if (ResponsiveHelper.isMobile(context)) {
      return EditScheduleAssignmentMobileSheet.show(context, enterpriseId, assignment);
    }
    return showDialog(
      context: context,
