class UpdateJobPostingState {
  const UpdateJobPostingState({
  ...
  UpdateJobPostingState copyWith({
    String? postingGuid,
    ...
    return UpdateJobPostingState(
      postingGuid: postingGuid ?? this.postingGuid,
