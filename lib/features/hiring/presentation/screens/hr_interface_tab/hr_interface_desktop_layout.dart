...
class HrInterfaceDesktopLayout extends StatelessWidget {
  const HrInterfaceDesktopLayout({required this.selectedEnterpriseId, required this.onEnterpriseChanged, super.key});
