...
class CreateOfferContractTypeSelectionDialog extends ConsumerWidget {
  const CreateOfferContractTypeSelectionDialog({super.key, this.selectedContractType});
  ...
  static Future<EmplLookupValue?> show({required BuildContext context, EmplLookupValue? selectedContractType}) {
    return DigifySingleSelectDialog.showAdaptive<EmplLookupValue>(
      context: context,
      child: CreateOfferContractTypeSelectionDialog(selectedContractType: selectedContractType),
    );
  }

  @override
  Widget build(BuildContext context, WidgetRef ref) {
    final asyncValues = ref.watch(createOfferContractTypeLookupValuesProvider);
    ...
    return DigifySingleSelectDialog<EmplLookupValue>(
      ...
      onRetry: () => ref.invalidate(createOfferContractTypeLookupValuesProvider),
    );
  }
}
