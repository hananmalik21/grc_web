...
class CreateRequisitionPositionSelectionDialog extends ConsumerWidget {
  const CreateRequisitionPositionSelectionDialog({super.key, this.selectedPosition});
  ...
  static Future<Position?> show({required BuildContext context, Position? selectedPosition}) {
    return DigifySingleSelectDialog.showAdaptive<Position>(
      context: context,
      child: CreateRequisitionPositionSelectionDialog(selectedPosition: selectedPosition),
    );
  }

  @override
  Widget build(BuildContext context, WidgetRef ref) {
    final state = ref.watch(createRequisitionPositionNotifierProvider);
    final notifier = ref.read(createRequisitionPositionNotifierProvider.notifier);
