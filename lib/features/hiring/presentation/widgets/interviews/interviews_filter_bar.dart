...
class InterviewsFilterBar extends ConsumerStatefulWidget {
  const InterviewsFilterBar({super.key});

  @override
  ConsumerState<InterviewsFilterBar> createState() => _InterviewsFilterBarState();
}

class _InterviewsFilterBarState extends ConsumerState<InterviewsFilterBar> {
            ...
            children: [
              Expanded(
                child: DigifyTextField.search(
                  ...
                  hintText: loc.hiringInterviewsSearchHint,
