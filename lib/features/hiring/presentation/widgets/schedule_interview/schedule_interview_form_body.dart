...
class ScheduleInterviewFormBody extends ConsumerWidget {
  const ScheduleInterviewFormBody({
    super.key,
  ...
  Widget build(BuildContext context, WidgetRef ref) {
    ...
    return Column(
      ...
      children: [
        if (binding.showsCandidatePicker)
          CandidateSearchField(
            label: loc.selectApplication,
            isRequired: true,
            hintText: loc.chooseApplicationHint,
            selectedCandidate: selectedCandidate,
            onCandidateSelected: (candidate) {
              onCandidateSelected?.call(candidate);
              ref.read(createNewInterviewProvider.notifier).setCandidate(candidate);
            },
