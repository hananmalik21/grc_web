                ...
                cells: [
                  ...
                  DataCell(
                    Text(
                      r.source,
                      style: TextStyle(
                        color: r.isSourceExposed ? const Color(0xFFEF4444) : const Color(0xFF94A3B8),
                        fontWeight: r.isSourceExposed ? FontWeight.w800 : FontWeight.w500,
                        fontFamily: 'monospace',
                      ),
                    ),
                  ),
                  ...
                  DataCell(
                    Text(
                      r.destination,
                      style: TextStyle(
                        color: r.isDestinationExposed ? const Color(0xFFEF4444) : const Color(0xFF94A3B8),
                        fontWeight: r.isDestinationExposed ? FontWeight.w800 : FontWeight.w500,
                        fontFamily: 'monospace',
                      ),
                    ),
                  ),
                  ...
                  DataCell(
                    Container(
                      ...
                      decoration: BoxDecoration(
                        ...
                        border: Border.all(color: r.risk.color.withValues(alpha: 0.4)),
                      ),
                      child: Text(
                        r.risk.label,
                        style: TextStyle(
