...
class LeaveBalanceTabletLayout extends StatelessWidget {
  const LeaveBalanceTabletLayout({required this.selectedEnterpriseId, required this.onEnterpriseChanged, super.key});
