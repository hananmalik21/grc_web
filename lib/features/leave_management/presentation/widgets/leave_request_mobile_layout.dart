...
import 'package:grc/features/leave_management/presentation/widgets/leave_entitlements_mobile_section.dart';
import 'package:grc/features/leave_management/presentation/widgets/leave_request_content.dart';
import 'package:flutter/material.dart';

class LeaveRequestMobileLayout extends StatelessWidget with LeaveRequestPermissionMixin {
  const LeaveRequestMobileLayout({required this.selectedEnterpriseId, required this.onEnterpriseChanged, super.key});
  ...
  Widget build(BuildContext context) {
    ...
    return LeaveRequestContent(
      ...
      header: LeaveEntitlementsMobileSection(localizations: localizations),
