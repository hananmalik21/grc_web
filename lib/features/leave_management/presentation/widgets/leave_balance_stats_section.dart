...
class LeaveBalanceStatsSection extends ConsumerStatefulWidget {
  const LeaveBalanceStatsSection({super.key});

  @override
  ConsumerState<LeaveBalanceStatsSection> createState() => _LeaveBalanceStatsSectionState();
}

class _LeaveBalanceStatsSectionState extends ConsumerState<LeaveBalanceStatsSection> {
          ...
          child: Row(
            ...
            children: [
              for (var index = 0; index < cards.length; index++) ...[
                SizedBox(width: cardWidth, child: _LeaveBalanceStatCard(data: cards[index])),
...
class _LeaveBalanceStatCardData {
  const _LeaveBalanceStatCardData({
    required this.title,
    required this.value,
...
class _LeaveBalanceStatCard extends StatelessWidget {
  const _LeaveBalanceStatCard({required this.data});

  final _LeaveBalanceStatCardData data;
