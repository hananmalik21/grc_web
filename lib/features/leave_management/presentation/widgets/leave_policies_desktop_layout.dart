...
class LeavePoliciesDesktopLayout extends StatelessWidget {
  const LeavePoliciesDesktopLayout({required this.selectedEnterpriseId, required this.onEnterpriseChanged, super.key});
