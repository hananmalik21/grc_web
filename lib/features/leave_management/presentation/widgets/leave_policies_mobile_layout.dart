...
class LeavePoliciesMobileLayout extends StatelessWidget {
  const LeavePoliciesMobileLayout({required this.selectedEnterpriseId, required this.onEnterpriseChanged, super.key});
  ...
  Widget build(BuildContext context) {
    ...
    return LeavePoliciesContent(
      ...
      header: DigifyMobileTabHeader(title: localizations.leavePolicies),
