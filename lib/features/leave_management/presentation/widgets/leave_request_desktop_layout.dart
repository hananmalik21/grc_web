...
class LeaveRequestDesktopLayout extends StatelessWidget with LeaveRequestPermissionMixin {
  const LeaveRequestDesktopLayout({required this.selectedEnterpriseId, required this.onEnterpriseChanged, super.key});
