...
import 'package:grc/features/compensation/presentation/providers/employee_compensation_detail_history_provider.dart';
...
class EmployeeCompHistorySectionForDetail extends ConsumerWidget {
  const EmployeeCompHistorySectionForDetail({super.key});

  @override
  Widget build(BuildContext context, WidgetRef ref) {
    final historyAsync = ref.watch(employeeCompHistoryForDetailPageProvider);
