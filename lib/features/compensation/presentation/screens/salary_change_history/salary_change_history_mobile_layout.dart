...
class SalaryChangeHistoryMobileLayout extends StatelessWidget {
  const SalaryChangeHistoryMobileLayout({
  ...
  Widget build(BuildContext context) {
    return SalaryChangeHistoryContent(
      ...
      header: DigifyMobileTabHeader(title: 'Salary Change History'),
