...
class AppColors {
  ...
  static const Color traceColor = Color(0xFF60A5FA);
  ...
  static const Color barPurple = Color(0xFFA78BFA);
  ...
  static const Color commandText = Color(0xFFA3E635);
  ...
  static const Color shadowColorLight = Color(0x0F000000);

  // Dialog & overlay
  static const Color dialogBarrier = Color(0x73000000);
  static const Color primaryOverlayLight = Color(0x1E155DFC);
  static const Color axisLabel = Color(0xFF6B7280);
  ...
  static const Color authDesktopTitle = Color(0xFF0A0A0A);
  static const Color authDesktopBody = Color(0xFF4A5565);
  static const Color authDesktopLabel = Color(0xFF364153);
  static const Color authDesktopFieldBorder = Color(0xFFD1D5DC);
  ...
  // Risk Detail Dialog Colors
  static const Color riskLinkedAssetChipBg = Color(0xFFE3EFFE);
  static const Color riskLinkedAssetChipBorder = Color(0xFFBAD0FF);
  static const Color riskInherentDetail = Color(0xFFC10007);
  static const Color riskResidualValue = Color(0xFF7E2A0C);

  // Assessment Framework Detail Colors
  static const Color radioSelected = Color(0xFF0075FF);
  static const Color radioBorder = Color(0xFF767676);
  static const Color statusOpenText = Color(0xFF1E2939);

  // GRC Programs & TPRM
  static const Color grcKpiCardBg = Color(0xFFE1EEFF);
  static const Color grcAssetChipBorder = Color(0xFFC0D3FF);
  static const Color grcChartAxisMuted = Color(0xFF666666);
  static const Color grcChartRadarGrid = Color(0xFFCCCCCC);
  static const Color grcChartRadarAxis = Color(0xFF808080);
  static const Color grcChartTargetBar = Color(0xFF93C5FD);

  // GRC Library / Question Form
  static const Color relatedControlChipText = Color(0xFF372AAC);

  // Cybersecurity Framework
  static const Color teal = Color(0xFF009689);
  static const Color tealBg = Color(0xFFCBFBF1);

  // Review progress / GRC dashboard
  static const Color primaryTint = Color(0xFFDBEAFE);
  static const Color healthTrendGreen = Color(0xFF7BF1A8);
  static const Color insightsBorder = Color(0xFFB6CDFF);
}
