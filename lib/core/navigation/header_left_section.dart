...
class HeaderLeftSection extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    final double menuPadding = context.responsive(
      mobile: 4.0.r,
      desktop: 6.0.r,
    );
    final double logoFontSize = context.responsiveFine(
      mobile: 18.0.sp,
      tabletSmall: 18.0.sp,
      tabletMedium: 20.0.sp,
      tabletLarge: 21.0.sp,
      desktop: 22.0.sp,
    );
        ...
        if (!isSidebarExpanded) ...[
          if (onLogoTap != null)
            InkWell(
              ...
              child: Padding(
                padding: EdgeInsets.all(menuPadding),
                child: GrcBrandMark(fontSize: logoFontSize),
              ),
            )
          else
            Padding(
