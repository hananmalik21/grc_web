import 'package:digify_security_console/digify_security_console.dart' as sc;
...
class _DigifyHrAuthTokenStorage implements sc.AuthTokenStorage {
...
class _HostScSpreadsheetExportNotifier extends sc.SpreadsheetExportNotifier {
  @override
  Future<void> export(
    BuildContext context, {
    required sc.ScSpreadsheetExportConfig config,
...
List<Override> buildSecurityConsoleHostOverrides() => [
  sc.activeEnterpriseIdProvider.overrideWith(
    (ref) => ref.watch(init.activeEnterpriseIdProvider),
  ),
  sc.enterprisesCacheProvider.overrideWith(
    (ref) => ref.watch(init.enterprisesCacheProvider) ?? const [],
  ),
  ...sc.buildScNetworkHostOverrides(
    baseUrl: (ref) => ApiConfig.baseUrl,
    authStorage: (ref) =>
        _DigifyHrAuthTokenStorage(ref.read(authLocalStorageProvider)),
  ),
  sc.spreadsheetExportProvider.overrideWith(
    _HostScSpreadsheetExportNotifier.new,
  ),
];
